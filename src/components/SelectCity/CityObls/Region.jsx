...
const Region = ({region, cts}) => {

    return (
        <div className="city-obl__links city-obl__links--actives">

            <div className="city-obl__top for-mobile">
                <button className="city-obl__back btn-reset"></button>
                <div className="city-obl__caption-mobile">{region}</div>
            ...
            <div className="city-obl__wrap">
                {cts.map( (city, i) => <a href="#" key={city + i} className="city-obl__link">{city}</a> )}
            </div>
        </div>
    );
};
